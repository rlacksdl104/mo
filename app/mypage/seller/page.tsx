...
const mockSellerProducts = [
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1611080626919-7cf5a9dbab5b?w=800&auto=format&fit=crop&q=60",
    category: "과일",
    status: "진행중",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=800&auto=format&fit=crop&q=60",
    category: "육류",
    status: "진행중",
...
export default function SellerMyPage() {
  ...
  const [productToCancel, setProductToCancel] = useState<typeof mockSellerProducts[0] | null>(null)
  ...
  const handleCancelProduct = (product: typeof mockSellerProducts[0]) => {
