...
// 참여중인 공구 (진행중)
const participatingOrders = [
  {
    id: "1",
    productName: "제주 감귤 5kg - 산지직송",
...
const cancelledOrders = [
  {
    id: "5",
    productName: "나주 배 5kg",
    imageUrl: "https://images.unsplash.com/photo-1514756331096-242fdeb70d4a?w=200&h=200&fit=crop",
    quantity: 1,
    unitPrice: 30000,
    totalPrice: 30000,
    status: "취소됨",
    cancelledAt: "2024-11-10",
    cancelReason: "목표 인원 미달",
  },
]
...
export default function BuyerMyPage() {
  ...
  const [selectedOrder, setSelectedOrder] = useState<typeof participatingOrders[0] | null>(null)
  ...
  const handleCancelClick = (order: typeof participatingOrders[0]) => {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-foreground">{participatingOrders.length}</p>
          ...
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-foreground">
                {(completedOrders.reduce((sum, o) => sum + o.totalPrice, 0) / 10000).toFixed(1)}만원
              </p>
        ...
        <Tabs defaultValue="participating" className="w-full">
          <TabsList className="w-full md:w-auto mb-6">
            <TabsTrigger value="participating" className="flex-1 md:flex-none">
              참여중 ({participatingOrders.length})
            </TabsTrigger>
